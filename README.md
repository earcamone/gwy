...
![GWY Gopher](https://raw.githubusercontent.com/earcamone/gwy/assets/images/v0.0.1/gopher3.jpg)
...
cycle (deploys, infra scaling, etc.) ?
...
creation events to run its CI.

![GWY Actions](https://raw.githubusercontent.com/earcamone/gwy/assets/images/v0.0.1/pr-ci-run.jpg)
...
are still some mandatory configuration you will have to do, though I tried to
make it as easy as possible.

### Mandatory Repository Token

GWY requires
a [GitHub fine-grained token](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-fine-grained-personal-access-token)
stored in your repo with secret name `GWY_TOKEN_REPO` with the following
permissions:
...
You need to create in your AWS account an  
access key with the following permissions:
...
can quickly assess the issues. Additionally, annotations and evidence markdown
artifacts will be attached to each run with the displayed summary and each
issues command output for more details.

[You can check GWY CI summary here.](https://github.com/earcamone/gwy-playground/actions/runs/14742809226)
...
entire branch name as version tag, assuming it's a feature branch version being
...
[You can check all generated badges here.](https://github.com/earcamone/gwy-playground/actions/runs/14744620184)
...
automatically all your count badges like `Downloads`.
